-- Fix session_notes table column names
-- Drop existing table if it has quoted column names
...
CREATE INDEX idx_session_notes_session_id ON session_notes(sessionId);
CREATE INDEX idx_session_notes_created_at ON session_notes(createdAt);
