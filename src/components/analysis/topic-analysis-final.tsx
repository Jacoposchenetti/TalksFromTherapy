    ...
    <div className="h-full flex flex-col">
      ...
      <div className="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <input
          ...
          className="w-full h-2 bg-gradient-to-r from-blue-500 to-blue-200 rounded-lg appearance-none cursor-pointer focus:outline-none focus:ring-1 focus:ring-blue-300"
        />
          ...
          <div className="space-y-6">
            ...
            {viewMode === 'network' && (
              <div className="space-y-3">
                ...
                <div className="min-h-[650px] border rounded-lg bg-gray-50 overflow-hidden">
                  <NetworkTopicVisualization
                    key={`network-${analysisResult.analysis_timestamp}-${analysisResult.network_data.nodes.length}`}
