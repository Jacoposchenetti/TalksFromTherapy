                  ...
                  className={`
                    ...
                    ${uploading || uploadingText || uploadingRecording || (!patientId && !selectedPatientForUpload)
                      ...
                      : isRecording 
                        ...
                        : 'border-red-300 bg-red-50 hover:border-red-400 hover:bg-red-100 hover:shadow-lg group-hover:scale-105'
                    }
                  `}
                >
                  {/* Recording Button Circle/Square */}
                  <div className="relative mb-4">
                    <div className={`
                      flex items-center justify-center transition-all duration-300 ease-in-out
                      ${isRecording 
                        ? 'w-12 h-12 rounded-lg bg-red-600 hover:bg-red-700 shadow-lg' 
                        : 'w-12 h-12 rounded-full bg-red-600 hover:bg-red-700 shadow-lg hover:shadow-xl'
                      }
                    `}>
                      {isRecording ? (
                    ...
                    {isRecording && (
                      <div className="absolute inset-0 rounded-lg border-2 border-red-400 opacity-60"></div>
                    )}
                  </div>
                  ...
                  <div className="text-center">
                    {uploadingRecording ? (
                      <p className="text-sm text-gray-600">Caricamento registrazione...</p>
                    ) : isRecording ? (
                      ...
                      <p className="text-sm text-gray-600">Clicca per iniziare a registrare</p>
                    )}
                  </div>
                  ...
                  {(isRecording || uploadingRecording) && (
                    <div className="flex items-center gap-2 mt-3">
                      <div className={`animate-spin rounded-full h-4 w-4 border-b-2 ${
                        isRecording ? 'border-red-600' : 'border-red-600'
                      }`}></div>
                      <span className={`text-sm ${
                        isRecording ? 'text-red-600' : 'text-red-600'
                      }`}>
            ...
            <Card key={session.id} className="hover:shadow-md transition-shadow w-full">
              <CardHeader>
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                  ...
                  <div className="flex gap-2 flex-wrap lg:flex-nowrap items-center justify-start lg:justify-end lg:min-w-fit">
                    {/* Mostra pulsante audio solo se esiste ancora il file audio */}
